// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CommentOnIssueCommand.cs" company="Copyright © 2013 Tekla Corporation. Tekla is a Trimble Company">
...
namespace ExtensionViewModel.Commands
{
    ...
    /// </summary>
    public class CommentOnIssueCommand : ICommand
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommentOnIssueCommand"/> class.
        /// </summary>
        public CommentOnIssueCommand()
        {
        ...
        /// The service.
        /// </param>
        public CommentOnIssueCommand(ExtensionDataModel model, ISonarRestService service)
        {
            this.model = model;
        ...
        public void Execute(object parameter)
        {
            ...
            if (list != null)
            {
                if (string.IsNullOrEmpty(this.model.CommentData))
                {
                    return;
                }

                var status = this.service.CommentOnIssues(this.model.UserConfiguration, new System.Collections.Generic.List<Issue>(list.Cast<Issue>().ToList()), this.model.CommentData);
                var allGood = true;
