...
namespace VSSonarExtensionUi.ViewModel.Configuration
{
    ...
    public class ExtensionOptionsModel : IViewModelBase
    {
        #region Fields
        ...
        /// The vs helper.
        /// </param>
        public ExtensionOptionsModel(PluginController plugincontroller, SonarQubeViewModel model, IVsEnvironmentHelper vsHelper)
        {
            this.model = model;
