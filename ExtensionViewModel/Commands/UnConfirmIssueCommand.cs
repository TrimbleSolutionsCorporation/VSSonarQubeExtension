// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UnConfirmIssueCommand.cs" company="Copyright © 2013 Tekla Corporation. Tekla is a Trimble Company">
...
namespace ExtensionViewModel.Commands
{
    ...
    /// </summary>
    public class UnConfirmIssueCommand : ICommand
    {
        /// <summary>
        ...
        public void Execute(object parameter)
        {
            ...
            if (list != null)
            {
                var status = this.service.UnConfirmIssues(this.model.UserConfiguration, new System.Collections.Generic.List<Issue>(list.Cast<Issue>().ToList()), this.model.CommentData);
                var allGood = true;
