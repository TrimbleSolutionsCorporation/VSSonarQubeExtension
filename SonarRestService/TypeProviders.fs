...
type JsonIssues = JsonProvider<""" {"maxResultsReached":false,"paging":{"pageIndex":1,"pageSize":100,"total":5,"pages":1},"issues":[{"key":"3de30475-4b63-45b2-9884-23bfbabff0e5","component":"organization:projectid:directory/filename.cpp","project":"organization:projectid","rule":"common-c++:InsufficientLineCoverage","status":"OPEN","resolution":"FIXED","severity":"MAJOR","actionPlan":"2e5bc6c2-d941-455e-a55a-96279a412754","message":"1 more lines of code need to be covered by unit tests to reach the minimum threshold of 40.0% lines coverage.","effortToFix":"1.0","creationDate":"2013-03-07T21:56:08+0200","updateDate":"2013-06-30T21:55:48+0300","closeDate":"2013-06-30T21:55:48+0300"},{"key":"df3c7c99-d6b5-4cec-8248-017201d092b6","component":"GroupId:Drawings:libgr_cloning/gr_cursor.cpp","project":"GroupId:Drawings","rule":"manual:this_is a manual review","status":"CONFIRMED","severity":"MAJOR","message":"please change this","line":4,"reporter":"login1","assignee":"username","creationDate":"2013-04-08T13:38:53+0300","updateDate":"2013-04-08T13:39:27+0300"},{"key":"22ecf99a-a2a1-419f-8783-48ba8238091e","component":"GroupId:Drawings:libgr_db/grdb_check.cpp","project":"GroupId:Drawings","rule":"manual:try_to detect when size is used without size_t","status":"CONFIRMED","severity":"MAJOR","message":"Try to detect when size is used without size_t","line":35,"reporter":"username","assignee":"username","creationDate":"2012-10-08T10:20:04+0300","updateDate":"2012-10-08T10:20:04+0300"},{"key":"a8f4984b-7be7-4d36-9c15-72e25431665b","component":"GroupId:TeklaStructures:libdialog/dia_option_button.cpp","project":"GroupId:TeklaStructures","rule":"cppcheck:unusedFunction","status":"CONFIRMED","severity":"MINOR","message":"The function 'SetBitmapName' is never used.","line":59,"assignee":"username","actionPlan":"7150a2d3-a933-4349-942b-9da831d45723","creationDate":"2012-11-15T06:59:33+0200","updateDate":"2012-11-20T11:52:57+0200","comments":[{"key":"a02da78a-aef1-4907-a05d-6092e0058c52","login":"username","htmlText":"can you check if these are false positives","createdAt":"2012-11-19T11:51:54+0200"},{"key":"b2d37d2b-4c82-4221-9ee1-2274071a1742","login":"vepi","htmlText":"Well technically they are not called, because BitmapName and InternalValue are only set by the constructor by the current code. However since diaOptionButton_ci is basically a data container with accessors, I think it's reasonable that there are symmetrical accessors to all the variables, even if they are not currently used.","createdAt":"2012-11-20T09:21:24+0200"},{"key":"c082b09b-d9a9-40de-a3a8-d149e7690a07","login":"username","htmlText":"same here","createdAt":"2012-11-20T11:52:57+0200"}]},{"key":"27ce6464-b4cb-4dc3-b3f2-3d614f8993ad","component":"GroupId:TeklaStructures:libdialog/dia_option_button.cpp","project":"GroupId:TeklaStructures","rule":"cppcheck:unusedFunction","status":"CONFIRMED","severity":"MINOR","message":"The function 'SetInternalValue' is never used.","line":46,"assignee":"username","actionPlan":"7150a2d3-a933-4349-942b-9da831d45723","creationDate":"2012-11-15T06:59:33+0200","updateDate":"2012-11-20T11:52:32+0200","comments":[{"key":"f920ca6d-ca85-4e93-ab55-0e1c9d91d699","login":"username","htmlText":"can you check if these are false positives","createdAt":"2012-11-19T11:51:37+0200"},{"key":"661b253a-6529-4637-8e5d-14808c00c0c5","login":"vepi","htmlText":"Well technically they are not called, because BitmapName and InternalValue are only set by the constructor by the current code. However since diaOptionButton_ci is basically a data container with accessors, I think it's reasonable that there are symmetrical accessors to all the variables, even if they are not currently used.","createdAt":"2012-11-20T09:21:50+0200"},{"key":"33852740-aad5-43b4-ac64-601ae93abcbe","login":"username","htmlText":"So is there a chance of unit test this? If not you may just mark it as false positive.","createdAt":"2012-11-20T11:52:32+0200"}]},{"key":"46429559-4e6c-455a-96b6-b5c75ecdd4d7","component":"GroupId:Dimensioning:libgr_dim_lib/grdl_dimensioning_adapter.cpp","project":"GroupId:Dimensioning","rule":"cppcheck:incorrectStringBooleanError","status":"CONFIRMED","severity":"MINOR","message":"A boolean comparison with the string literal \"dmlGetSteelDimensioningInstance\" is always true.","line":49,"assignee":"username","creationDate":"2013-02-21T13:06:03+0200","updateDate":"2013-02-22T09:45:06+0200","comments":[{"key":"88b4beab-25db-48c9-b688-98ee1bcf7e40","login":"username","htmlText":"how are we fixing those? do i need to update the tool not to generate this cases?","createdAt":"2013-02-22T09:36:03+0200"},{"key":"87eb635a-45fa-4af7-a58c-18db97300fe3","login":"pafi","htmlText":"Please update the tool if you can restrict this to ASSERT() expressions. Otherwise we might want to change this - this could be changed by having if(test) { ASSERT(!&quot;&lt;message&gt;&quot;) } but this makes it longer (and also messes with the test coverage - condition is never met)","createdAt":"2013-02-22T09:45:06+0200"}]}],"components":[{"key":"GroupId:TeklaStructures:libdialog/dia_option_button.cpp","qualifier":"FIL","name":"dia_option_button.cpp","longName":"libdialog/dia_option_button.cpp"},{"key":"GroupId:Dimensioning:libgr_dim_lib/grdl_dimensioning_adapter.cpp","qualifier":"FIL","name":"grdl_dimensioning_adapter.cpp","longName":"libgr_dim_lib/grdl_dimensioning_adapter.cpp"},{"key":"GroupId:Drawings:libgr_cloning/gr_cursor.cpp","qualifier":"FIL","name":"gr_cursor.cpp","longName":"libgr_cloning/gr_cursor.cpp"},{"key":"GroupId:Drawings:libgr_db/grdb_check.cpp","qualifier":"FIL","name":"grdb_check.cpp","longName":"libgr_db/grdb_check.cpp"}],"projects":[{"key":"GroupId:Drawings","qualifier":"TRK","name":"Drawings","longName":"Drawings"},{"key":"GroupId:Dimensioning","qualifier":"TRK","name":"Dimensioning","longName":"Dimensioning"},{"key":"GroupId:TeklaStructures","qualifier":"TRK","name":"TeklaStructures","longName":"TeklaStructures"}],"rules":[{"key":"manual:this_is a manual review","name":"This is a manual review","desc":"Rule created on the fly. A description should be provided.","status":"READY"},{"key":"cppcheck:incorrectStringBooleanError","name":"Suspicious comparison of boolean with a string literal","desc":"A boolean comparison with the string literal is always true.","status":"READY"},{"key":"cppcheck:unusedFunction","name":"Unused function","desc":"The function is never used.","status":"READY"},{"key":"manual:try_to detect when size is used without size_t","name":"Try to detect when size is used without size_t","desc":"Rule created on the fly. A description should be provided.","status":"READY"}],"users":[{"login":"pafi","name":"Filoche Pascal","active":true,"email":"pascal.filoche@tekla.com"},{"login":"username","name":"Costa Jorge","active":true,"email":"jorge.costa@tekla.com"},{"login":"login1","name":"","active":true},{"login":"vepi","name":"Piril\u00e4 Vesa","active":true,"email":"vesa.pirila@tekla.com"}],"actionPlans":[{"key":"7150a2d3-a933-4349-942b-9da831d45723","name":"Gate 3 Version  19.1","status":"OPEN","project":"GroupId:TeklaStructures","desc":"Gate 3 Version  19.1","userLogin":"username","createdAt":"2012-10-25T09:23:34+0300","updatedAt":"2013-06-29T13:23:45+0300"}]} """>

type JsonIssue = JsonProvider<""" {"issue":{"key":"062ffaed-5484-4585-8e79-3d0fa2b7eaae","actionPlan":"2e5bc6c2-d941-455e-a55a-96279a412754","component":"organization:projectid:directory/file.cpp","project":"organization:projectid","line":4,"assignee":"userlogin","rule":"common-c++:InsufficientBranchCoverage","status":"REOPENED", "resolution":"FIXED", "severity":"MINOR","message":"203 more branches need to be covered by unit tests to reach the minimum threshold of 30.0% branch coverage.","effortToFix":"203.0","creationDate":"2013-03-10T12:04:31+0200","closeDate":"2013-06-30T21:55:48+0300","updateDate":"2013-07-18T13:51:07+0300","comments":[{"key":"14050e05-9b80-4aff-a7a2-0d11ebe2c393","login":"login","htmlText":"this is a comment","createdAt":"2013-07-17T22:21:00+0300"},{"key":"5c3b60d2-26df-4b3b-9309-e3d4920c0ae7","login":"login","htmlText":"this is another comment","createdAt":"2013-07-17T22:28:40+0300"},{"key":"46f10914-4475-4708-9afc-d47977953a29","login":"login1","htmlText":"yet another comment","createdAt":"2013-07-17T22:46:02+0300"},{"key":"8d5e33c8-c92e-4063-b235-6e32e543ea5b","login":"login1","htmlText":"yet another comment","createdAt":"2013-07-17T23:42:44+0300"},{"key":"762c3b35-542f-4816-bb2c-77eeb7a9be36","login":"login1","htmlText":"fdlkflds","createdAt":"2013-07-17T23:43:13+0300"},{"key":"f805e632-7e53-489b-bf57-73009a652e70","login":"login1","htmlText":"akskjds","createdAt":"2013-07-17T23:45:20+0300"},{"key":"b213d614-bca4-4c21-bb6a-df5ecded4f50","login":"login1","htmlText":"fsdfsd","createdAt":"2013-07-17T23:46:44+0300"},{"key":"65a727c1-d72c-40dc-8794-0af85b325f9f","login":"login1","htmlText":"fsdfsd","createdAt":"2013-07-17T23:55:07+0300"},{"key":"f4af7854-f462-4652-8e50-12ca7a1d21a2","login":"login1","htmlText":"fgsdgdfghgfgh","createdAt":"2013-07-17T23:55:19+0300"},{"key":"0e1f1936-4666-45fb-922e-17f5d79a547e","login":"login1","htmlText":"another comment","createdAt":"2013-07-18T10:57:42+0300"},{"key":"22deb9b7-3a2f-4da6-aa02-1469860cb0e9","login":"login1","htmlText":"fgfdgdfgdf fgfd","createdAt":"2013-07-18T12:24:31+0300"},{"key":"0c837a06-479a-4988-88fb-e8835be53e0d","login":"login1","htmlText":"sdfdsfsd","createdAt":"2013-07-18T12:25:22+0300"},{"key":"e2b6fc7e-af5f-4397-9170-36e6b17f5691","login":"login1","htmlText":"sdsadsa asdsa d","createdAt":"2013-07-18T12:26:38+0300"}]}} """>
...
type JSonComment = JsonProvider<""" {"comment":{"key":"b213d614-bca4-4c21-bb6a-df5ecded4f50","login":"login1","htmlText":"fsdfsd","createdAt":"2013-07-17T23:46:44+0300"}} """>
