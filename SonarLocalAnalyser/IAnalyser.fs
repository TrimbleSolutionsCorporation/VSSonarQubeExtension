...
type ISonarLocalAnalyser =     
  ...
  abstract member AnalyseFile : VsFileItem * Resource * onModifiedLinesOnly:bool *  version:double * ISonarConfiguration * SQKeyTranslator * vsInter : IVsEnvironmentHelper -> unit
